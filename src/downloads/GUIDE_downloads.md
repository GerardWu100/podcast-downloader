...
- 2026-06-22: `download.log`, `activity.log`, and embedded MP3 download-date metadata now use the shared Toronto/Eastern timezone, with human-facing logs formatted to minutes.
